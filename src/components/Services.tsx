          ...
          {services.map((item, i) => (
            <Reveal key={item.id} delay={i * 0.1}>
              <TiltCard maxTilt={5} className="h-full">
                <div className="group relative bg-[#4a0e1e] border border-royal-gold/20 p-10 md:p-14 transition-all duration-500 hover:bg-white overflow-hidden rounded-br-[4rem] h-full">
